...
PATH_CENSUS_CSV = '/var/www/statmap/httpdocs/data/census/co-est2019-alldata.csv'
...
PATH_ACTIVE_US_DATA = '/var/www/statmap/httpdocs/data/active/API.ACTIVE.USDATA.json'
PATH_PREVACTIVE_US_DATA = '/var/www/statmap/httpdocs/data/active/API.PREVACTIVE.USDATA.json'
...
for k in DateToCountyData.keys():
    ...
    date_code = k
    if '2020' in k:
        date_code = date_code.replace('2020','20').replace('-','')
    if '2021' in k:
        date_code = date_code.replace('2021','21').replace('-','')
    if '2022' in k:
        date_code = date_code.replace('2022','22').replace('-','')
    print("CODE", date_code)
